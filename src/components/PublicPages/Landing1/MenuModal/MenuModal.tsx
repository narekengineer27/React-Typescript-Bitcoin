                            ...
                            <TabPanel className={styles.relative}>
                                <div className={styles.panel}>
                                    ...
                                    <div className={styles.panel_text}>
                                        <p>XchangeRate platform is primarily community driven. The community decides what exchanges is integrated. The community votes using XRR Tokens. Integrating an exchange would require 50,000 Votes from the exchange’s community. XchangeRate decides voting sessions based on registration made by exchanges or their representatives. At the end of a voting session the exchange with the votes starts integration process.</p>
                            ...
                            <TabPanel className={styles.relative}>
                                <div className={styles.panel}>
                                    ...
                                    <div className={styles.panel_text}>
                                        ...
                                        <p>Our platform can be used either as a Do-It-Yourself Coin Monitoring Board (CMB) with our intelligent XchangeRate indicators, or as a totally dependable smart algorithm designed for all user levels of traders (Autobot).
XchangeRate algorithms run in test or active modes using preset indicators so that user inputs are not required. Each preset has a performance history that traders can refer to and use for different market conditions </p>
                                        <p>Traders are required to hold a minimum of 5000XRR on a designated wallet to access the traders dashboard (CMB). Using the autobot requires further XRR subscription determined by duration of use.</p>
                            ...
                            <TabPanel className={styles.relative}>
                                <div className={styles.panel}>
                                    ...
                                    <div className={styles.panel_text}>
                                        ...
                                        <p>XchangeRate offers a 2-way chat platform that makes it convenient to conclude deals quickly and stay in touch with your clients. The modules are easy to use and can host multiple tokens as well as multiple accounts. With a very affordable fee structure the Market Maker is getting so much for less. Our platform makes it easy to report activities between Market Maker and their clients in addition to recording all Exchange volumes for the token. </p>
                            ...
                            <TabPanel className={styles.relative}>
                                <div className={styles.panel}>
                                    ...
                                    <div className={styles.panel_text}>
                                        <p>XchangeRate platform is a liquidity solution for exchanges. It is a must have integration because it hosts traders, token owners and market makers in one convenient place. </p>
                                        ...
                                        <p>To qualify for integration, there is a voting process where Exchanges garner votes from their community – the community votes give the winning Exchange free integration to our Autobot and CMB (coin monitoring board).Our Market Maker integration would be subject to conditions by the integration team. </p>
                                        <p>For paid integration, a sum of 3 BTC equivalent in XRR tokens is required for full integration. Full integration gives access to Autobot, Market Maker and cross promotion/ announcement.</p>
